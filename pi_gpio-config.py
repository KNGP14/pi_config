...
def printRaspberry(model):
    if(model in ["Rasberry Pi Model 2B v1.1"]):
        print(f'{Fore.GREEN}')
        print(f' ┌────────────────────────────────────────┐  ')
        print(f' │ {Fore.WHITE}₂₄₆₈₀{Fore.YELLOW}₂₄₆₈₀{Fore.BLUE}₂₄₆₈₀{Fore.MAGENTA}₂₄₆₈₀{Fore.GREEN}                ╔══╧═ ')
        print(f' │ {Fore.WHITE}₁₃₅₇₉{Fore.YELLOW}₁₃₅₇₉{Fore.BLUE}₁₃₅₇₉{Fore.MAGENTA}₁₃₅₇₉{Fore.GREEN}                ║ {Fore.RESET}USB{Fore.GREEN} ')
        print(f' │                                     ╚══╤═ ')
        print(f' │                                        │  ')
...
print('{0: >19}  {1}GPIO9{2} {3}(21) (22){4} {5}GPIO25{6} {7: <19}{8}'.format(getGPIO(9) , "", "", Fore.BLUE, Fore.RESET, "", "", getGPIO(25), pi_box_end))
print('{0: >19} {1}GPIO11{2} {3}(23) (24){4} {5}GPIO8{6}  {7: <19}{8}'.format(getGPIO(11), "", "", Fore.BLUE, Fore.RESET, "", "", getGPIO(8), pi_box_end))
print('{0: >19}    {1}GND{2} {3}(25) (26){4} {5}GPIO7{6}  {7: <19}{8}'.format("", Style.DIM, Style.NORMAL, Fore.BLUE, Fore.RESET, "", "", getGPIO(7), pi_box_end))
print('{0: >19}  {1}GPIO0{2} {3}(27) (28){4} {5}GPIO1{6}  {7: <19}{8}'.format(getGPIO(0) , "", "", Fore.BLUE, Fore.RESET, "", "", getGPIO(1), pi_box_end))
print('{0: >19}  {1}GPIO5{2} {3}(29) (30){4} {5}GND{6}    {7: <19}{8}'.format(getGPIO(5) , "", "", Fore.BLUE, Fore.RESET, Style.DIM, Style.NORMAL, "", pi_box_end))
